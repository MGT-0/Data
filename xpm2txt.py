...
for y_index, data_value in enumerate(xpm_data):
    ...
    for x_index, x_value in enumerate(x_axis):
        symbol = data_value[x_index]
        if symbol in letter_to_value:
            txt_values.append([x_value, y_value, letter_to_value[symbol]])
        else:
            sys.stderr.write(f'Warning: Symbol "{symbol}" not found in legend. Skipping.\n')
